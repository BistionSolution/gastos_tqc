    ...
    function (require) {
        ...
        var ProgressBarNew = AbstractField.extend({
            ...
            start: function () {
                ...
                this.canWrite = !this.readonly && (this.mode === 'edit' || (this.editable_readonly && this.mode === 'readonly') || (this.viewType === 'kanban') );// Keep behavior before commit
                ...
                if (this.canWrite) {
                    if (this.edit_on_click) {
                        this.$el.on('click', '.o_progress', function (e) {
                                ...
                                var numValue = Math.floor((e.pageX - $target.offset().left) / $target.outerWidth() *
                                        self.max_value);
            ...
            on_update: function (value) {
                if (this.edit_max_value) {
                    ...
                    // _setValues accepts stringandwillparseit
            ...
            _render_value: function (v) {
                ...
                this.$('.o_progress').toggleClass('o_progress_overflow', value >
                    max_value).attr('aria-valuemin', '0').attr('aria-valuemax', max_value).attr('aria-valuenow', value);
