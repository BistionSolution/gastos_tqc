...
And substring(cen.CENTRO_COSTO,1,2) in ('22','23','41','42','43','44','45','49','51','52','53','58','59')"""
                ...
                sql = """select cen.CENTRO_COSTO,cen.CUENTA_CONTABLE,cta1.DESCRIPCION,cen.ESTADO from AGRAVENT.CENTRO_cuenta cen
...
WHERE CTA1.ACEPTA_DATOS='S' AND CEN.ESTADO='A' AND (CEN.CENTRO_COSTO NOT IN ('00.00.00.00') AND SUBSTRING(CEN.CENTRO_COSTO,1,2)<>'21') AND SUBSTRING(CTA1.CUENTA_CONTABLE,1,1)='6' AND CC1.ACEPTA_DATOS='S'"""
