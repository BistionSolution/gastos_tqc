...
class TqcAuth(models.Model):
    ...
    _description = 'Niveles de Autorizadores'
    ...
    def load_autorizadores(self):
        ...
        table_relations = """department_id OF hr.department,
                            user_id OF res.users,
                            job_id OF hr.job"""
    ...
    # def calcular_esta(self):
    #     print("EJECUTO CORRECTAMENTEGAAAAAAAAAAAAAAAAAAAAAAAA")
    ...
    def masive_auth(self):
        ...
        ids_not_aprob = self.env["hr.employee"].search([('user_id.id', 'not in', listsup)]).mapped("user_id").mapped("id")
